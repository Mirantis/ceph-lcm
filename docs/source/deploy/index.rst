...
In the future, it will be possible to run shrimp services on different
...
If you have such a diversity, please use Docker registry
to manage Shrimp images or dump/load them manually. To do so, build

...
Decapod uses plugins to manage Ceph. These plugins support various tasks,
such as cluster deployment, adding and removing of OSDs, and others.
...
.. toctree::
   ...
   playbook-plugins/plugin-add-client.rst
   playbook-plugins/plugin-add-mds.rst
   ...
   playbook-plugins/plugin-deploy-cluster.rst
   playbook-plugins/plugin-purge-cluster.rst
   playbook-plugins/plugin-purge-telegraf.rst
   playbook-plugins/plugin-remove-client.rst
   playbook-plugins/plugin-remove-mds.rst
   ...
   playbook-plugins/plugin-upgrade-ceph.rst
